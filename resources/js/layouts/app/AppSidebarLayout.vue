...
<template>
  <div class="min-h-screen w-screen flex bg-gray-50">
    ...
    <aside class="group fixed left-0 top-0 z-50 h-screen w-16 hover:w-48 bg-white shadow-lg border-r border-gray-200 transition-all duration-300 ease-in-out">
      <div class="flex flex-col h-full py-4">
        <!-- Logo -->
        <div class="px-2 mb-4 flex items-center justify-center" >
          <a href="/dashboard" class="w-7 h-7 flex items-center justify-center flex-shrink-0 px-3 py-2.5 bg-blue-600 rounded-xl text-white hover:bg-blue-700 transition-colors">
          ...
          <nav class="flex flex-col space-y-2 w-full px-2">
            ...
            <div>
              <a 
                ...
                title="Profile"
              >
                <div class="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center text-white font-medium text-xs flex-shrink-0">
