...
<template>
    <div class="flex min-h-screen w-screen bg-gray-50">
            ...
            <div class="flex h-full flex-col py-4">
                ...
                <div class="mb-6 flex items-center justify-center px-2">
                    <a href="/dashboard" class="flex h-10 w-10 items-center justify-center">
                        <img src="logo.png" alt="Logo Meetly" class="h-100 w-100 object-contain" />
                    </a>
                </div>
                ...
                <div class="flex flex-1 items-center justify-start">
                    <nav class="flex w-full flex-col space-y-8 px-3">
                        ...
                        <Link href="/dashboard"
                            ...
                            <svg class="h-6 w-6" fill="none" stroke="#D84040" stroke-width="2" viewBox="0 0 24 24">
                        ...
                        <Link href="/explore"
                            ...
                            <svg class="h-6 w-6" fill="none" stroke="#D84040" viewBox="0 0 24 24" stroke-width="2">
                ...
                <div class="relative mt-auto mb-3 px-3" ref="profileDropdownRef">
                    <button @click="toggleProfileDropdown"
                        ...
                        <div class="ml-1 hidden flex-1 text-left group-hover:block">
        ...
        <!-- Main Content -->
        <main class="ml-16 min-h-screen flex-1 transition-all duration-300 ease-in-out">
            <slot />
        </main>
