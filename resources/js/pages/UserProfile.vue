...
<template>
    ...
    <AppSidebarLayout @open-post="openPostModal">
        <AppHeaderLayout>
            <main class="mx-auto max-w-2xl px-8 py-8 sm:px-6 md:px-10 lg:px-8">
                <!-- Profile Header -->
                <div
                    class="mb-8 overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm"
                >
                    <!-- Profile Info -->
                    <div class="px-6 py-6">
                        <div class="flex items-center justify-start space-x-10">
                            <!-- Profile Avatar -->
                            <div
                                class="mt-5 flex h-40 w-40 items-center justify-center rounded-full border-4 border-white bg-white text-2xl font-bold text-gray-600 shadow-lg"
                                :style="{
                        ...
                        <div class="mt-6">
                            <p class="text-gray-700">
                                Welcome to my profile! I love sharing thoughts
                    ...
                    <div class="border-b border-gray-200">
                        <nav class="-mb-px flex">
                            ...
                            <button
                                @click="setActiveTab('posts')"
                                :class="[
                                    'flex-1 border-b-2 px-1 py-4 text-center text-sm font-medium transition-colors',
                                    activeTab === 'posts'
                                        ? 'border-blue-500 text-blue-600'
                    ...
                    <div class="min-h-[400px]">
                        ...
                        <div v-show="activeTab === 'replies'">
                            ...
                            <div v-else class="px-6 py-12 text-center">
                                ...
                                <p class="text-gray-500">
                                    {{ profileUser.name }} hasn't replied to any
                                    posts.
                                </p>
                            </div>
                        </div>
