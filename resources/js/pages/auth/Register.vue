...
<template>
    <AuthLayout>
        <div class="bg-white rounded-xl shadow-lg p-12 w-full max-w-2xl mx-auto">
            ...
            <h2 class="text-2xl font-bold text-gray-900">Register Your Account</h2>
            <p class="mt-1 text-gray-600 mb-6">
                Complete the information below to register your account
            </p>
                    ...
                    <div class="relative">
                        ...
                        <button type="button" @click="showPassword = !showPassword"
                            ...
                            <svg v-if="!showPassword" class="w-5 h-5" fill="none" viewBox="0 0 24 24">
                                ...
                                <path stroke="currentColor" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943
                                   9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                            </svg>
                            <svg v-else class="w-5 h-5" fill="none" viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7
            ...
            <div class="mt-6 text-center">
                <div class="flex items-center">
                    ...
                    <span class="px-3 text-gray-500 text-sm">Already have an account?</span>
                    <div class="flex-1 border-t border-gray-300"></div>
                </div>
