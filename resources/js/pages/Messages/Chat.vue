            ...
            <div class="p-4 pt-0">
              ...
              <div v-else>
                ...
                <div v-if="filteredChats.length === 0"
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 md:w-16 md:h-16 text-gray-300 mb-3"
                      ...
                      <div class="flex-1 min-w-0">
                        ...
                        <div class="flex items-center gap-1.5 text-xs">
                          <template v-if="chat.last_message && chat.unread_count === 0">
                            ...
                            <svg v-else class="w-3 h-3 md:w-3.5 md:h-3.5 text-gray-400 flex-shrink-0"
                              viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                              <path d="M20 6L9 17l-5-5" />
                            </svg>
                          </template>
